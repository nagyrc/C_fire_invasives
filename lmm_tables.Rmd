...
rbind(MuMIn::r.squaredGLMM(final_mods$ABG) %>% as.data.frame,
  ...
  cbind(.,data.frame(model = c("Above-ground biomass Carbon",
                                "Below-ground biomass Carbon",
                                "Litter Carbon", "Soil organic Carbon",
                                "Soil total Carbon"))) %>%
...
row1<-ggarrange(p4a, p4b, p4c, nrow=1)
row2<-ggarrange(p4d, p4e, nrow=1, widths=c(2,1))
